...
public class EmployeeDAO {
	...
	public void save(Employee emp){
		...
		int rows = jdbcTemplate.update(sql, new Object[]{ emp.getCode(), emp.getName(), emp.getRole().getId(), emp.getEmailId(), emp.getMobileNo()});
	...
	public void update(Employee emp) {
		...
		int rows = jdbcTemplate.update(sql, emp.getCode(), emp.getName(), emp.getRole().getId() , emp.getEmailId(), emp.getMobileNo(), emp.isActive(), emp.getId());
